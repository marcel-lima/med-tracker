export const MEDS = {
  ...
  predsim:   { name: 'Predsim',       dose: '1 cp',         freq: '1× morning', g1: '#FED9B7', g2: '#F39A55', ink: '#8C4116' },
  aerolin:   { name: 'Aerolin',       dose: '4 jatos',      freq: '6/6h',     g1: '#C9ECD6', g2: '#7BCFA0', ink: '#1F6B40' },
  rinossoro: { name: 'Rinossoro',     dose: '120ml/nostril', freq: '3× day',  g1: '#FECCD2', g2: '#F08FA0', ink: '#923146' },
};
